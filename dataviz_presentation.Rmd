...
```{r echo=FALSE, message=FALSE, warning = FALSE, fig.show='hide', eval=FALSE} 
...
```{r warning = FALSE, message=FALSE, echo=FALSE, fig.show='hide', eval=FALSE}
...
```{r boattrolley, echo=FALSE, message=FALSE, warning = FALSE, fig.show='hide', eval=FALSE}
...
.center[<img src="Plots/treemap.jpg" width="48%">]
...
```{r echo=FALSE, message=FALSE, warning = FALSE, eval=FALSE, fig.show='hide'}
aux %>% 
  ggplot(aes(x = Income, y = PrevalenceHIV, col = four_regions) ) + 
  geom_point(alpha = 0.8) + 
  scale_x_log10() +
